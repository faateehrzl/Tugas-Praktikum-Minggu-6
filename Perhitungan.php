<?php
    ...
    include "index.php";
    echo "<br><div id='main_struk'><h1><b>NOTA</b></h1></div>";
    ...
    class buah {
        ...
        public function getMangga(){
            ...
            echo "<div id='struk'>Total Harga Mangga : Rp.$this->totalMangga</div>";
        }
            
        public function getJambu(){
            $this->totalJambu = $this->jambu * 13000;
            echo "<div id='struk'>Total Harga Jambu : Rp.$this->totalJambu</div>";
        }  

        public function getSalak(){
            $this->totalSalak = $this->salak * 10000;
            echo "<div id='struk'>Total Harga Salak : Rp.$this->totalSalak</div>";
        }
